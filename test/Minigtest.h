...
class MiniTestCase {
public:
  MiniTestCase(const char *case_name)
      : nTestResult(1), testcase_name(case_name) {}
...
public:                                                                        \
    ...
    (const char *case_name) : MiniTestCase(case_name){};                       \
    virtual void Run();                                                        \
  \
private:                                                                       \
  ...
  \
\
MiniTestCase *const TESTCASE_NAME(testcase_name)::testcase_ =                  \
      MiniUnitTest::GetInstance()->RegisterTestCase(                           \
          new TESTCASE_NAME(testcase_name)(#testcase_name));                   \
  \
void TESTCASE_NAME(testcase_name)::Run()

#define MTEST(testcase_name) MINI_TEST_(testcase_name)

#define MRUN_ALL_TESTS() MiniUnitTest::GetInstance()->Run();
